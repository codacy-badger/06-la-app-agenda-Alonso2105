...
var vistaTabla = new VistaWeb(document.querySelector("#informacion"));
...
export default class Agenda {
    ...
    _actualizacion() {
        let mContactos = JSON.parse(localStorage.getItem("contactos"));
        if (mContactos === null) {
            return;
        }
        mContactos.forEach((contacto, index) => {
